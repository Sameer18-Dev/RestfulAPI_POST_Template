...
public class MainActivity extends AppCompatActivity {
    ...
    private void signUp() {
        ...
        String val = String.valueOf(currentTime);
        Api.getClient().registration(name.getText().toString().trim(), password.getText().toString().trim(), val,"email","email","email","email","email","email","email","email","email","email","email","email","email","email","email","email","email","email","email","email","email","email","email","email","email","email", new Callback<SignUpResponse>() {
                    @Override
